      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Subscribe to our newsletter for tips and news.</p>
            <form className="flex flex-col sm:flex-row gap-2">
              ...
              />
              <button className="bg-primary hover:bg-oilmax-dark text-white px-4 py-2 rounded-md transition-colors">
                Subscribe
              </button>
            </form>
          </div>
