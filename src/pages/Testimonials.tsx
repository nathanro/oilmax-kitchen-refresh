      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            <div className="flex flex-col items-center justify-center p-6 bg-gray-50 rounded-lg hover:bg-gray-100 transition duration-300 min-h-[160px]">
              ...
              <span className="text-sm text-gray-700 font-medium text-center">Burger King</span>
            </div>
            <div className="flex flex-col items-center justify-center p-6 bg-gray-50 rounded-lg hover:bg-gray-100 transition duration-300 min-h-[160px]">
              <div className="flex-1 flex items-center justify-center w-full mb-4">
                <img 
              ...
              <span className="text-sm text-gray-700 font-medium text-center">Major Donut Chain</span>
            </div>
            <div className="flex flex-col items-center justify-center p-6 bg-gray-50 rounded-lg hover:bg-gray-100 transition duration-300 min-h-[160px]">
              <div className="flex-1 flex items-center justify-center w-full mb-4">
                <img 
              ...
              <span className="text-sm text-gray-700 font-medium text-center">Sparkler Filters</span>
            </div>
            <div className="flex flex-col items-center justify-center p-6 bg-gray-50 rounded-lg hover:bg-gray-100 transition duration-300 min-h-[160px]">
              <div className="flex-1 flex items-center justify-center w-full mb-4">
                <img 
              ...
              <span className="text-sm text-gray-700 font-medium text-center">Restaurant Chain</span>
            </div>
          </div>
          
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
            <div className="flex items-center bg-white px-8 py-4 rounded-lg border-2 border-blue-500 shadow-lg hover:shadow-xl transition duration-300">
              <img src="/lovable-uploads/8b3f12a8-04f2-4e91-9394-0bcab197b832.png" alt="FDA Recognized" className="h-16 w-16 object-contain mr-4 flex-shrink-0" />
              <div className="text-left">
                <span className="text-blue-700 font-bold text-lg block">FDA Recognized</span>
                <p className="text-blue-600 text-sm">Since 1960s</p>
              </div>
            </div>
            <div className="flex items-center bg-white px-8 py-4 rounded-lg border-2 border-blue-500 shadow-lg hover:shadow-xl transition duration-300">
              <img src="/lovable-uploads/6d64327d-2bb2-4afd-b9e3-2e4e6db37742.png" alt="USDA Approved" className="h-16 w-16 object-contain mr-4 flex-shrink-0" />
              <div className="text-left">
                <span className="text-blue-700 font-bold text-lg block">USDA Approved</span>
                <p className="text-blue-600 text-sm">Since 1960s</p>
              </div>
            </div>
            <div className="flex items-center bg-white px-8 py-4 rounded-lg border-2 border-blue-500 shadow-lg hover:shadow-xl transition duration-300">
              <img alt="Made in USA" className="h-16 w-16 object-contain mr-4 flex-shrink-0" src="/lovable-uploads/94dda56b-e179-48ca-971a-b2cfcf05563d.png" />
              <div className="text-left">
                <span className="text-blue-700 font-bold text-lg block">Made in USA</span>
                <p className="text-blue-600 text-sm">Since 1960s</p>
              </div>
            </div>
          </div>
